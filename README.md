...
- **📦 Seven official plugins** *(v1.5)*: Campaign Board · Content Pipeline · GitHub Triage · Inbox Agent · Weekly Report · Client Folders · Decision Log — real uses of the engine, one click away, every outward step behind an approval
...
| [Official plugin library](docs/guide/library.md) | 📦 Campaign Board · Content Pipeline · GitHub Triage · Inbox Agent · Weekly Report · Client Folders · Decision Log — one click each |
